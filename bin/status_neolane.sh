...
case $env in
        PROD )
            ...
            ssh -t $Host1 "sudo  echo  '***************STATUT NEOLANE***************' && sudo /etc/init.d/nlserver6 status && sudo echo '***************STATUT_APACHE***************' &&  sudo /etc/init.d/httpd status " ;;


        ACC )

            ssh -t $Host2 "sudo echo '***************STATUT_APACHE***************' && sudo /etc/init.d/httpd  status && sudo  echo  '***************STATUT NEOLANE***************' && sudo /etc/init.d/nlserver6 status";;
