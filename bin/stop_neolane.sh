...
case $env in
        PROD )
            ...
            ssh -t $Host1 "sudo  echo -e '***************STOPPING NEOLANE***************' && sudo /etc/init.d/nlserver6 stop && sudo echo '***************STOPPING APACHE***************' &&  sudo /etc/init.d/httpd stop" ;;

        ACC )

            ssh -t $Host2  "sudo  echo -e '***************STOPPING APACHE***************' && sudo /etc/init.d/httpd stop && sudo echo '***************STOPPING NEOLANE***************' &&  sudo /etc/init.d/nlserver6 stop" ;;
        * )
