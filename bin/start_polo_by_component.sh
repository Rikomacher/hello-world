...
# Ce sript start le service JBoss pour un ou plusieurs composants POLO
PRG=`dirname $0`
...
{
    echo
    echo "Ce sript start le service JBoss pour un ou plusieurs composants POLO"
    echo "usage: `basename $0` -OPTIONS"
    echo "Exemple : `basename $0` -e t4 -c all"
    echo "    -e | --env      Nom de l'environnement"
    echo "    -c | --comp     Composant à démarrer (pgw ou ws ou backoffice ou booking ou async ou rules ou rules-deploy ou polo-batch ou polo-batchCatalog ou ALL)"
...
#echo "On relance un seul composant"
hostDone=""
