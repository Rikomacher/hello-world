...
# Ce sript affiche le stop des services pour un ou plusieurs composants WS
PRG=`dirname $0`
...
{
    echo
    echo "Ce sript affiche le stop des services pour un ou plusieurs composants WS"
